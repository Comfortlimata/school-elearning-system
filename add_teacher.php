...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_num_rows($check_email) > 0) {
        ...
        // Insert teacher data with password
        $sql = "INSERT INTO teachers (
            ...
            '$name', '$email', '$hashed_password', '$phone', '$specialization', '$qualification', $experience_years,
            '$bio', '$image_path', '$department', '$office_location', '$office_hours',
            '$linkedin_url', '$twitter_url', '$facebook_url', " . ($salary ? $salary : "NULL") . ", '$hire_date', '$status'
        )";
        
        if (mysqli_query($data, $sql)) {
            $message = "Teacher added successfully! Default password: '$default_password'";
            $_POST = array();
        } else {
